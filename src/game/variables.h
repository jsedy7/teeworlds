...
MACRO_CONFIG_INT(SvInactiveKick, sv_inactivekick, 3, 3, 3, CFGFLAG_SAVE|CFGFLAG_SERVER, "How to deal with inactive clients (0=move player to spectator, 1=move player to spectator and kick spectator, 2=move to free spectator slot/kick, 3=kick)")
